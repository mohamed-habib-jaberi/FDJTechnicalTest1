...
struct LeaguesMock {
    ...
    static let leaguesList = [
        ...
        League(idLeague: "4332", strLeague: "spain Premier League", strSport: "Soccer", strLeagueAlternate: "Premier League, EPL"),
        League(idLeague: "4332", strLeague: "spain Premier League", strSport: "Soccer", strLeagueAlternate: "2eme League, EPL")
